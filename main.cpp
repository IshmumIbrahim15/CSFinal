...
int main()
{
    ...
    cout << "use your wits to find your way out. Good luck!" << endl
         << endl;

    printImages.printKingdom();
    ...
    // compile: g++ main.cpp enemies.cpp locations.cpp miniGames.cpp player.cpp rooms.cpp
    Locations location;
    location.yourCell(p);
    return 0;
}